...
<div class="py-3 mb-4 shadow-sm bg-warning border-top">
    <div class="container">
        ...
        <a href="#" class="text-success">Trending Products /</a>
        ...
        <div class="card shadow h-100 product_data"> 
            <div class="card-body">
                <div class="row">
                    ...
                    &nbsp;&nbsp;&nbsp;<label class="font-weight-bold text-dark">Selling Price :&nbsp;&nbsp;<span class="text-danger" style="font-size:22px"><b>&#2547;</b>&nbsp;{{$product->selling_price}}</span></label>
